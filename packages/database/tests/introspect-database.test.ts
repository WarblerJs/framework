...
const INDEX_ROWS = [
  { tableName: "roles", indexName: "roles_pkey", isPrimary: true, isUnique: true, columns: ["id"] },
  { tableName: "roles", indexName: "roles_name_key", isPrimary: false, isUnique: true, columns: ["name"] },
  { tableName: "users", indexName: "users_pkey", isPrimary: true, isUnique: true, columns: ["id"] },
  { tableName: "users", indexName: "users_email_key", isPrimary: false, isUnique: true, columns: ["email"] },
];
