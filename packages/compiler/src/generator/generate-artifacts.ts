...
export function generateArtifacts(optimized: OptimizedApplication, bindings?: ExecutableBindingPlan): GeneratedApplication {
  ...
  if (bindings !== undefined) {
    ...
    if (bindings.validators.length > 0) files["validators.generated.ts"] = executableValuesSource("validatorBindings", "validate", bindings.validators);
...
export async function writeArtifacts(projectRoot: string, generated: GeneratedApplication): Promise<void> {
