...
export function generateArtifacts(
  ...
  const files: Record<string, string> = {
    ...
    // and exists purely to declaration-merge into @warblerjs/http's WarblerRequestContext.
...
function tablesSource(value: OptimizedApplication): string {
  return `/* Generated by @warblerjs/compiler. Do not edit. */
...
function isEventDispatcherBinding(binding: ProviderBindingPlan): boolean {
  return binding.registration === "class" && binding.implementation?.imported === "EventDispatcher" && binding.implementation.module === "@warblerjs/events";
}
...
function executableProvidersSource(bindings: ExecutableBindingPlan): string {
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { ProviderBinding, ProviderBindingContext } from "@warblerjs/runtime";
${imports}
export const providerBindings = Object.freeze([
${rows}
]) satisfies readonly ProviderBinding[];
${providersSource().replace("/* Generated by @warblerjs/compiler. Do not edit. */\n", "")}`;
}
function eventsSource(optimized: OptimizedApplication, bindings: ExecutableBindingPlan | undefined): string {
  if (bindings === undefined || (bindings.events.length === 0 && bindings.eventListeners.length === 0 && bindings.eventInterceptors.length === 0)) {
    return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { EventRuntimeBindings } from "@warblerjs/events";
...
function controllersSource(bindings: ExecutableBindingPlan): string {
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { ControllerBinding, ProviderBindingContext } from "@warblerjs/runtime";
${imports}
...
`).join("\n");
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { HandlerBinding } from "@warblerjs/runtime";
${imports}
${functions}
...
function validatorsSource(bindings: readonly (BindingImport & { readonly id: number })[]): string {
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import { compileValidator } from "@warblerjs/validators";
${renderImports(bindings)}
${compiled}
...
`
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { HttpRouteExecutor } from "@warblerjs/runtime";
${hasValidators ? `import { prepareHttpValidationInput } from "@warblerjs/http";
...
function bindingsSource(bindings: ExecutableBindingPlan, optimized: OptimizedApplication): string {
  ...
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import type { GeneratedApplicationBindings } from "@warblerjs/runtime";
${imports}
...
function productionSource(): string {
  return `/* Generated by @warblerjs/compiler. Do not edit. */
import { createExecutableBindingsRuntime, type ExecutableBindingsRuntime, type GeneratedApplicationBindings } from "@warblerjs/runtime";
...
/**
 * Emits a pure type-level `declare module "@warblerjs/http"` augmentation merging every
