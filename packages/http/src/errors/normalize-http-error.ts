import { normalizeError, WarblerError, type NormalizedWarblerError } from "@warbler/core";
 ...
 * itself, delegates straight to `@warbler/core`'s transport-agnostic `normalizeError`.
 */
